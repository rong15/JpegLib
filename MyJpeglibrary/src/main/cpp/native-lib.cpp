...
Java_com_zourong_myjpeglibrary_BitmapUtil_compressBitmap(JNIEnv *env,
    ...
    LOGE("file_name:::::::: = %d", bitmap_format);
...
Java_com_zourong_myjpeglibrary_BitmapUtil_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
